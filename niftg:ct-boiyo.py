...
while True:
    ...
    if score >= 3 and  score < 5:
          print("Great Job, {}!".format(name),"You passed with a score of {}!".format(score))
    ...
    # Round 2:
    # Question 1: How many minutes in one quarter of a football game?
    # Question 2: How does a football game commence?
    # Question 3: What football franchise currently hold the most SuperBowl championship wins?
    # Question 4: What is the term used to refer to an infraction committed by a player on the field?
        A. Foul
        B. Red Card
        C. Penalty/flag 


    # Question 2: Where is the football Hall of Fame located?
        A. Canton, Ohio
        B. Cooperstown, New York
        C. Springfield, Massachusetts

    # Question 3: How many offensive linemen are on the field during an offensive playcall?
        A. 10
        B. 5
        C. 9

    # Question 4: Which one of these 3 numbers can a wide receiver in the NFL wear?
        A. 11
        B. 1
        C. 90
